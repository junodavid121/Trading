...
extern double setProfit = 8;
extern double setStopLoss = 1000;
extern double MM_Start = 0.01; 
extern double MM_Profit_Add = 1;
...
bool determineOrder(int period, int type)
{
  ...
  //Buy if Ask price below MA line
    if(!SelectLastCurrentTrade(OP_BUY))
    {
      return true;
    }
  ...
  else if(type == OP_SELL)
  {
    ...
    if(!SelectLastCurrentTrade(OP_SELL))
    {
      return true;
    }
